...
Encoder myEnc1(A0, A1);        // the number of the encoder 1 pins
Encoder myEnc2(A2, A3);        // the number of the encoder 2 pins
Encoder myEnc3(A4, A5);        // the number of the encoder 2 pins
